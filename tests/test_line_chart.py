...
class TestBasics:
    """Test suite for line_chart_race functionality."""
    ...
    def test_lines(self):
        """Test number of lines parameter."""
        bcr.line_chart_race(df_race, n_lines=8)

    def test_images_country(self):
        """Test country images parameter."""
        bcr.line_chart_race(df_race, n_lines=4, images='country')

    def test_others_line_func(self):
        """Test others line function parameter."""
    ...
    def test_period_summary_func(self):
        ...
        def psf(values: pd.Series) -> Dict[str, Any]:
            total = values.sum()
    ...
    def test_line_width_data(self):
        """Test line width data parameter."""
        bcr.line_chart_race(
            df_race[df_pop.columns], n_lines=5, images='country',
    ...
    def test_fade(self):
        """Test fade parameter."""
        bcr.line_chart_race(
            df_race[df_pop.columns], images='country',
    ...
    def test_custom_images(self):
        """Test custom images parameter."""
        url = 'https://icons.iconarchive.com/icons/wikipedia/flags/1024/US-United-States-Flag-icon.png'
        images = [url] * 5
        bcr.line_chart_race(
            df_race, n_lines=5, images=images, title='COVID-19 Deaths',
            steps_per_period=5, line_width_data=df_pop, fade=.9
        )
    ...
    def test_font(self):
        ...
        bcr.line_chart_race(
            df_race, n_lines=5, images='country', steps_per_period=5,
            line_label_font=5, tick_label_font=4
        )
    ...
    def test_line_kwargs(self):
        """Test line keyword arguments."""
        bcr.line_chart_race(
            df_race, n_lines=5, images='country',
            steps_per_period=5, line_kwargs={"ls": '--', 'lw': 2, 'alpha': .3}
        )

    def test_fig_kwargs(self):
        """Test figure keyword arguments."""
        bcr.line_chart_race(
            df_race, n_lines=5, images='country',
    ...
    def test_videos(self):
        """Test saving to video formats."""
        bcr.line_chart_race(
            df_race, 'tests/videos/lcr_yellow.mp4', n_lines=5, images='country',
            steps_per_period=5, fig_kwargs={'facecolor': 'yellow'}
        )

        bcr.line_chart_race(
            df_race, 'tests/videos/test_html.html', n_lines=5, images='country',
            steps_per_period=5
        )
